...
class Brain:
    ...
    def _crop_cycle(self, crop):
        ...
        Valuing fertilizer per crop (f8abb39) made the agent fertilize more,
        and the extra yield lands on sq-curve products whose price it crashes:
        21/40 against bot_ref where this version takes 39/40. The blanket
        price gate is cruder and measurably better."""
